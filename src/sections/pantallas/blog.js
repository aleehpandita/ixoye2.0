...
import thumb1 from 'assets/images/blog/tv1.jpg';
import thumb2 from 'assets/images/blog/tv2.jpg';
import thumb3 from 'assets/images/blog/tv3.jpg';
import thumb4 from 'assets/images/blog/tv4.jpg';
...
const data = [
  ...
  },
  {
    ...
    thumbnail: thumb3,
    showDescription: false,
    title: `Llamanos al 9983 816839 para cotizar sin compromiso`,
    description: `The 2019 Innovation by Design Awards honor the designers and businesses solving the problems of today and tomorrow. It is one of the most sought-after design`,
  },
  {
    id: 4,
    ...
    thumbnail: thumb2,
    showDescription: true,
    title: `Mantenimiento de Televisores`,
    description: `Solicita la reparación de tu televisor o tu plasma con tecnicos certificados por la marca.`,
  },
  {
    id: 5,
    slug: '#how-to',
    ...
    description: `Nosotros sólo utilizamos piezas y refacciones nuevas; originales de fábrica, para la reparación de sus plasmas OLED, LED y mas.`,
  },
];
    ...
    <Box as="section" id="blog" sx={styles.section}>
      <Container>
        <SectionHeading
          ...
          description="¿Tu Televisor, PLASMA, LED ya no funciona? ¿Necesita una pieza original? ¿Ya no prende tu tv? Contactanos y Cotiza sin compromiso."
        />
