...
import illustration from 'assets/images/banner-tv.png';
    ...
    <Box as="section" id="home" sx={styles.section}>
      <Container>
        <Box sx={styles.contentWrapper}>
          <SectionHeading
            sx={styles.heading}
            title="Reparación & Matenimiento de Pantallas y Televisores"
            description="¿Problemas con tu pantalla LED o OLED o PLASMA? Reparamos tu Pantalla de cualquier tipo. Servicio a domicilio 24/7"
          />
