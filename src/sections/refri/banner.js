...
import illustration from 'assets/images/banner-refri.png';
    ...
    <Box as="section" id="home" sx={styles.section}>
      <Container>
        <Box sx={styles.contentWrapper}>
          <SectionHeading
            sx={styles.heading}
            title="Reparación & Matenimiento de Refrigeradores"
            description="¿Problemas en tu hogar u oficina? Reparamos tu Refrigerador y/o Congelador. Servicio a domicilio 24/7"
          />
