...
import uber from 'assets/images/logos/cinsa.png';
import google from 'assets/images/logos/calorex.png';
import paypal from 'assets/images/logos/magamex.png';
import microsoft from 'assets/images/logos/foset.png';
import dribbble from 'assets/images/logos/leflam.png';

const data = [
  {
    id: 1,
    logo: uber,
    author: 'Reparacion de Boiler Cinsa',
    quote: `Técnicos altamente calificados en todas las marcas con repuestos originales. Garantizamos la reparación de sus boilers y/o calentadores de gas o electricos.`,
  },
  {
    id: 2,
    logo: google,
    author: 'Reparacion de Boiler Calorex',
  ...
  },
  {
    id: 5,
    logo: dribbble,
    author: 'Reparacion de Boiler Leflam',
    quote: `Técnicos especializados en todas las marcas. Reparacion de Calentadores. Reparación de Boiler electricos, Reparacion de Boilers de paso y calentadores de gas`,
  },
];
