...
import illustration from 'assets/images/banner-bombas.png';
    ...
    <Box as="section" id="home" sx={styles.section}>
      <Container>
        <Box sx={styles.contentWrapper}>
          <SectionHeading
            sx={styles.heading}
            title="Reparación & Matenimiento de Bombas e Hidroneumaticos"
            description="¿Necesita una bomba de agua? ¿Su hidroneumatico dejo de funcionar? Reparamos tu Bomba de cualquier tipo. Servicio a domicilio 24/7"
          />
