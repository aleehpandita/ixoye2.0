...
import illustration from 'assets/images/banner-boiler.png';
    ...
    <Box as="section" id="home" sx={styles.section}>
      <Container>
        <Box sx={styles.contentWrapper}>
          <SectionHeading
            sx={styles.heading}
            title="Reparación & Matenimiento de Boilers y Calentadores"
            description="Técnico en boilers de paso, electricos, de gas, solares o de depósito. Reparamos tu Calentador o tu boiler de cualquier tipo. Servicio a domicilio 24/7"
          />
