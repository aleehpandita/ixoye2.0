...
import tabImage1 from 'assets/images/boiler.png';
...
const data = [
  ...
  },
  {
    ...
    description: ` No dudes en acercarte con los profesionales en reparación de boilers y calentadores en Cancún y Playa del Carmen.`,
    moreLink: '#explore-more',
    image: tabImage1,
    list: [
      'Piezas de fabrica',
