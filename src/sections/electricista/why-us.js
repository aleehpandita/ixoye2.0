...
import tabImage1 from 'assets/images/electricista.png';
...
const data = [
  ...
  },
  {
    ...
    description: `Por favor comuniquese con nosotros al 998 381 6839 ya sea por llamada o WhatsApp y te atenderemos de manera inmediata`,
    moreLink: '#explore-more',
    image: tabImage1,
    list: [
      'Luneas a Sábado',
  ...
  },
  {
    ...
    description: ` No dudes en acercarte con los profesionales en reparación de tuberias. Mantenimiento de tinacos. Instalaciones de bombas, y más.`,
    moreLink: '#explore-more',
    image: tabImage1,
    list: [
      'Piezas de fabrica',
